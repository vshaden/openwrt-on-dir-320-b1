...
define Profile/DIR320B2
	NAME:=D-Link DIR-320/NRU rev B2
	PACKAGES:=\
		kmod-usb-core kmod-usb-rt305x-dwc_otg \
		kmod-ledtrig-usbdev kmod-mppe kmod-rt2800-pci \
		kmod-usb2 kmod-usb-ohci kmod-ledtrig-netdev
...
define Profile/DIR320B2/Description
	Package set for DIR-320/NRU rev B2 board
endef

$(eval $(call Profile,DIR320B2))
